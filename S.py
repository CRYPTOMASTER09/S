...
def print_welcome_message():
    ...
    ascii_art = pyfiglet.figlet_format("Crypto", font="small")
    ascii_art1 = pyfiglet.figlet_format("MASTER", font="small")
    print(Fore.CYAN + ascii_art + Style.RESET_ALL)
    print(Fore.CYAN + ascii_art1 + Style.RESET_ALL)
    print(Fore.YELLOW + "t.me/airdropconfirm97")
    print(Fore.CYAN + Style.BRIGHT + "●▬▬▬▬▬๑۩ CRYPTO MASTER۩๑▬▬▬▬▬●")
